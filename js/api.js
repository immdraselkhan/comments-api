...
const getPosts = post => {
    ...
    postDiv.innerHTML = `
        <div id="modal-box" class="fixed top-0 left-0 w-full h-screen flex items-center justify-center bg-emerald-500 bg-opacity-30 transform scale-100 transition-transform duration-300">
